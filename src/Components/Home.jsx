      ...
      <div className="row">
        <div className="col-sm-6">
          <main role="main" class="inner cover p-4">
            <h1 class="cover-heading">React crud page by AD Pal.</h1>
            <p class="lead">This is the React CRUD Home page by AD pal. <br />
        ...
        <div className="col-sm-6 mt-5 ms-0">
          <img src="" alt="crud img" height={"400px"} width={"670px"}/>
        </div>
      </div>
    </div>
  )
