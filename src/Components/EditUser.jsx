                        ...
                        <fieldset className='form-control bg'>
                            ...
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="name" placeholder="Enter Your Name." value={this.state.name}
                                     onChange={(event) =>
                                    {
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" className="form-control" id="mobile" placeholder="Enter Your Mobile Number" value={this.state.mobile} onChange={(event) => { this.setState({ mobile: event.target.value }) }} />
                                </div>
                                <div className="form-group">
